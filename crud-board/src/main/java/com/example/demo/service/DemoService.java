...
public class DemoService {
  ...
  public int insertArticle(MemberVO loginMember, HashMap<String, String> articleMap, HttpServletRequest req) {
    ...
    int board_no = mapper.selectBoardIdByName(articleMap.get("board_name"));
  ...
  public int modifyArticle(MemberVO loginMember, HashMap<String, String> articleMap, HttpServletRequest req, int article_no_int) {
	  ArticleVO article = new ArticleVO();
	  String article_ip = req.getLocalAddr();
	  
	  article.setArticle_no(article_no_int);
	  article.setMember_no(loginMember.getMember_no());
	  article.setArticle_name(articleMap.get("article_name"));
	  article.setArticle_content(articleMap.get("content"));
	  article.setArticle_ip(article_ip);
  ...
  public int deleteArticle(MemberVO loginMember, HashMap<String, String> articleMap, HttpServletRequest req, int article_no_int) {
	  ArticleVO article = new ArticleVO();
	  String article_ip = req.getLocalAddr();
