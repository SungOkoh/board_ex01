...
//    }
  ...
  @RequestMapping("board/**/modify.form")
  public String modifyarticleform(HttpServletRequest req, HttpSession session, Model model) {
	  MemberVO loginMember = (MemberVO) session.getAttribute("loginMember");
  ...
  @RequestMapping("board/**/delete.form")
  public String deletearticle(HttpServletRequest req, HttpSession session, Model model) {
	  MemberVO loginMember = (MemberVO) session.getAttribute("loginMember");
...
//    return "main_area/lists/"+result;
  ...
  @RequestMapping("/board/**/postModify.do")
  public String postModify(@RequestParam HashMap<String, String> articleMap, HttpServletRequest req, HttpSession session) {
	  MemberVO loginMember = (MemberVO) session.getAttribute("loginMember");
	  
	  articleMap.put("board_name", "free");
	  String article_no= req.getParameter("article_no");
	  int article_no_int = Integer.parseInt(article_no);
	  service.modifyArticle(loginMember, articleMap, req, article_no_int);
	  
	  return "redirect:/board/" + "free" + ".do";
  }
  
  @RequestMapping("/board/**/postDelete.do")
  public String postDelete(@RequestParam HashMap<String, String> articleMap, HttpServletRequest req, HttpSession session) {
	  MemberVO loginMember = (MemberVO) session.getAttribute("loginMember");
	  
	  articleMap.put("board_name", "free");
	  String article_no= req.getParameter("article_no");
	  int article_no_int = Integer.parseInt(article_no);
	  service.deleteArticle(loginMember, articleMap, req, article_no_int);
