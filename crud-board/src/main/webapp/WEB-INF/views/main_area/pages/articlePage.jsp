...
<div class="content_area">
  ...
  <div class="info">
    <table class="articleInfoTable">
      ...
      <form action="/demo/board/<%=lastUri%>/modify.form">
      	<input type="hidden" name="article_no" value="<c:out value='${articlePageModel.article_no}'/>">
        <input type="submit" value="수정">
    </form>
    
          <form action="/demo/board/<%=lastUri%>/delete.form">
      	<input type="hidden" name="article_no" value="<c:out value='${articlePageModel.article_no}'/>">
